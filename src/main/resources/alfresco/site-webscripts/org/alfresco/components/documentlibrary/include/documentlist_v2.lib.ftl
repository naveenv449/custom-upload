         ...
         <div id="${id}-headerBar" class="header-bar flat-button theme-bg-2">
            <@markup id="toolbarLeft">
               <div class="left">
                  ...
                  <#-- UPLOAD BUTTON -->
				   <#if page.url.templateArgs.site?? && page.url.templateArgs.site!="custom-upload">
				 ...
				 <#-- UPLOAD BUTTON -->
                  ...
                  <@markup id="uploadButton">
                     <#if uploadable>
                        <div class="hideable toolbar-hidden DocListTree">
                           <div class="file-upload">
                              <span id="${id}-custom-upload-fileUpload-button" class="yui-button yui-push-button">
                                 <span class="first-child">
                                    <button name="fileUpload">Custom Upload</button>
                                 </span>
                              </span>
                           </div>
                        </div>
